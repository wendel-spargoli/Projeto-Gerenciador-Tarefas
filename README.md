...
Assim que o projeto principal estiver funcionando redondinho, adicione estas melhorias:


Data Limite (Deadline): Adicione um campo de data e crie uma verificação para avisar se a tarefa está atrasada.


Relatório: Adicione uma opção no menu para exportar um relatório formatado em um arquivo de texto .txt.
